...
def calc_average(temperature_final, temperature_initial, minutes):
    temperature_final += temperature_initial
    temperature_final /= minutes
    return round(temperature_final)


def print_all(temperature_final, temperature_initial, average_temperature):
    ...
    print("Average Temperature: ", format(average_temperature, ".2f"))
...
def main():
    ...
    minutes = get_minutes()
    average_temperature = calc_average(temperature_final, temperature_initial, minutes)
    print_all(temperature_final, temperature_initial, average_temperature)
